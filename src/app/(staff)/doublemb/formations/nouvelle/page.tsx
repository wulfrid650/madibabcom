...
export default function NouvelleFormationPage() {
    ...
    const fetchFormateurs = async () => {
        try {
            const { data } = await api.getUsers(1, '', 'formateur');
            setFormateurs(data.map((u: any) => ({
                id: u.id,
                name: u.name,
                email: u.email,
                speciality: u.speciality // Assuming User model has this or it's in a relationship
            })));
        } catch (err) {
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Créer une nouvelle formation professionnelle</p>
                    </div>
                </div>
            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ex: Formation BIM Architecture"
                                    />
                                </div>
