                ...
                <div className="p-8">
                    ...
                    <div className="space-y-4 mb-8">
                        <div className="flex justify-between py-2 border-b border-gray-100">
                            ...
                            <span className="font-medium text-gray-900">Madiba Building Construction</span>
                        </div>
                        <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Client</span>
                            <span className="font-medium text-gray-900">{payment.metadata?.customer_first_name || payment.metadata?.customer_name || 'Client'}</span>
                        </div>
                        <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    {/* Promo Code Section */}
                    {/* Only show if payment is not already fully validated/completed */}
